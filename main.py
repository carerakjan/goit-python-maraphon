...
while playing:
    ...
    if keys[constants.K_DOWN] and player_rect.bottom < HEIGHT:
       player_rect = player_rect.move(player_move_down)

    if keys[constants.K_RIGHT] and player_rect.right < WIDTH:
        player_rect = player_rect.move(player_move_right)
    
    if keys[constants.K_UP] and player_rect.top > 0:
        player_rect = player_rect.move(player_move_up)

    if keys[constants.K_LEFT] and player_rect.left > 0:
